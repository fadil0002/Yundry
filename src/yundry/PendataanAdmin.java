 ...
 * @author HP
 */
public class PendataanAdmin extends javax.swing.JFrame {

    /**
     * Creates new form PendataanAdmin
     */
    public PendataanAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PendataanAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PendataanAdmin().setVisible(true);
            }
        });
    }
